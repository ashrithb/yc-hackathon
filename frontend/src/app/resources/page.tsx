...
export default function Resources() {
  const resourceCategories = [
    {
      ...
      icon: "🛠️",
      resources: [
        { name: "MVP Development Guide", description: "How to build your minimum viable product", link: "/library" },
    ...
    },
    {
      ...
      icon: "📈",
      resources: [
        { name: "Growth Hacking Playbook", description: "Proven strategies for user acquisition", link: "#" },
        { name: "Content Marketing Templates", description: "Blog post and social media templates", link: "#" },
        { name: "SEO Starter Kit", description: "Essential SEO tools and guides", link: "#" },
        { name: "Email Marketing Setup", description: "Templates and automation workflows", link: "#" }
      ]
    },
    {
      ...
      icon: "💰",
      resources: [
        { name: "Financial Model Templates", description: "Revenue projections and burn rate calculators", link: "#" },
        { name: "Unit Economics Calculator", description: "LTV/CAC and other key metrics", link: "#" },
        { name: "Investor Pitch Deck Template", description: "Proven deck structure and examples", link: "#" },
        { name: "Startup Accounting Guide", description: "Financial best practices for startups", link: "#" }
      ]
    }
  ]
  ...
  const tools = [
    ...
    {
      name: "Hacker News",
      description: "Tech community and news",
      type: "Community",
      link: "https://news.ycombinator.com"
    },
    {
      name: "Launch YC",
      description: "Platform for launching products",
      type: "Launch",
      link: "/launches"
    },
    {
      name: "YC Deals",
      description: "Exclusive discounts for YC companies",
      type: "Perks",
      link: "/deals"
    }
  ]
    ...
    <div className="min-h-screen bg-[#f6f6f2]">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <nav className="hidden md:flex space-x-8">
              ...
              <Link href="/resources" className="text-[#c6542c] hover:text-gray-900 font-medium">Resources</Link>
            </nav>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="text-center mb-16">
          <h1 className="text-5xl font-bold text-[#c6542c] mb-6">Startup Resources</h1>
          <p className="text-xl text-gray-700 max-w-3xl mx-auto">
            Everything you need to build and grow your startup. From legal templates to
            financial models, we've gathered the best resources for founders.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 lg:grid-cols-6 gap-6 mb-16">
          {tools.map((tool, index) => (
            ...
            >
              ...
              <span className="text-xs bg-[#c6542c] text-white px-2 py-1 rounded">{tool.type}</span>
            </Link>
          ))}
        </div>
      </section>
      ...
      {/* Resource Categories */}
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <h2 className="text-4xl font-bold text-center mb-12">Resource Categories</h2>
            ...
            <div key={index} className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <div className="space-y-4">
                {category.resources.map((resource, resourceIndex) => (
                  <div key={resourceIndex} className="border-l-4 border-[#c6542c] pl-4">
                    <Link href={resource.link} className="block hover:bg-gray-50 p-2 rounded transition-colors">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="border border-gray-200 p-6 rounded-lg">
              ...
              <div className="flex items-center justify-between mb-4">
                <span className="text-sm text-gray-500">Excel • 2MB</span>
                <span className="text-sm text-gray-500">25K+ downloads</span>
              </div>
            ...
            <div className="border border-gray-200 p-6 rounded-lg">
              <h3 className="text-xl font-bold mb-3">Pitch Deck Template</h3>
              <p className="text-gray-600 mb-4">PowerPoint template based on successful YC company pitch decks.</p>
              <div className="flex items-center justify-between mb-4">
                <span className="text-sm text-gray-500">PPT • 5MB</span>
                <span className="text-sm text-gray-500">35K+ downloads</span>
              </div>
              <button className="w-full bg-[#c6542c] text-white py-2 rounded hover:bg-orange-600 transition-colors">
                Download
              </button>
      ...
      {/* External Resources */}
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <h2 className="text-4xl font-bold text-center mb-12">Recommended External Resources</h2>
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          <div className="bg-white p-6 rounded-lg shadow-sm">
            <h3 className="font-bold mb-2">GitHub</h3>
            <p className="text-sm text-gray-600 mb-3">Code hosting and version control</p>
            <a href="https://github.com" target="_blank" className="text-[#c6542c] hover:underline text-sm">Visit →</a>
          </div>

          <div className="bg-white p-6 rounded-lg shadow-sm">
            <h3 className="font-bold mb-2">Figma</h3>
            <p className="text-sm text-gray-600 mb-3">Design and prototyping tool</p>
            <a href="https://figma.com" target="_blank" className="text-[#c6542c] hover:underline text-sm">Visit →</a>
          </div>

          <div className="bg-white p-6 rounded-lg shadow-sm">
            <h3 className="font-bold mb-2">Notion</h3>
            <p className="text-sm text-gray-600 mb-3">All-in-one workspace and documentation</p>
            <a href="https://notion.so" target="_blank" className="text-[#c6542c] hover:underline text-sm">Visit →</a>
          </div>

          <div className="bg-white p-6 rounded-lg shadow-sm">
            <h3 className="font-bold mb-2">Stripe</h3>
            <p className="text-sm text-gray-600 mb-3">Payment processing infrastructure</p>
            <a href="https://stripe.com" target="_blank" className="text-[#c6542c] hover:underline text-sm">Visit →</a>
          </div>

          <div className="bg-white p-6 rounded-lg shadow-sm">
            <h3 className="font-bold mb-2">AWS</h3>
            <p className="text-sm text-gray-600 mb-3">Cloud computing services</p>
            <a href="https://aws.amazon.com" target="_blank" className="text-[#c6542c] hover:underline text-sm">Visit →</a>
          </div>

          <div className="bg-white p-6 rounded-lg shadow-sm">
            <h3 className="font-bold mb-2">Vercel</h3>
            <p className="text-sm text-gray-600 mb-3">Frontend deployment platform</p>
            <a href="https://vercel.com" target="_blank" className="text-[#c6542c] hover:underline text-sm">Visit →</a>
          </div>

          <div className="bg-white p-6 rounded-lg shadow-sm">
            <h3 className="font-bold mb-2">PostHog</h3>
            <p className="text-sm text-gray-600 mb-3">Product analytics and insights</p>
            <a href="https://posthog.com" target="_blank" className="text-[#c6542c] hover:underline text-sm">Visit →</a>
          </div>

          <div className="bg-white p-6 rounded-lg shadow-sm">
            <h3 className="font-bold mb-2">Mixpanel</h3>
            <p className="text-sm text-gray-600 mb-3">User behavior analytics</p>
            <a href="https://mixpanel.com" target="_blank" className="text-[#c6542c] hover:underline text-sm">Visit →</a>
          </div>
        </div>
      </section>
      ...
      <section className="bg-[#c6542c] py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-orange-100 mb-8 max-w-2xl mx-auto">
            Get notified when we add new resources, templates, and tools to help you build your startup.
          </p>
